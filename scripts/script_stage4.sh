...
torchrun --standalone --nproc_per_node=8 /path/to/orion_msp/train/run.py \
            ...
            --checkpoint_dir /my/stage4/checkpoint/dir \
            --checkpoint_path /my/stage3/checkpoint/dir/step-{last}.ckpt \
...
torchrun --standalone --nproc_per_node=8 /path/to/orion_msp/train/run.py \
            ...
            --poly_decay_power 2.0 \
            --gradient_clipping 1.0 \
            --prior_dir /path/to/prior/stage4/ \
            --prior_type mix_scm \
            --load_prior_start 0 \
            --batch_size_per_gp 2 \
            ...
            --checkpoint_dir /my/stage4/checkpoint/dir \
            --checkpoint_path /my/stage4/checkpoint/dir/step-{last}.ckpt \
